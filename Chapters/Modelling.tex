...
\FloatBarrier
\subsection{Additional Translational Motion Equations}
...
\begin{figure}[htb]
	\includegraphics[width=\columnwidth]{HexacopterConfig.jpg}%
...
\[\tau_{\psi}=K(F_{1}-F_{2}+F_{3}-F_{4}+F_{5}-F_{6})\]
\end{flushleft}
...
\begin{figure}[htb]
\begin{center}
	\includegraphics[width=80mm]{ModelBlockDiagram.jpg}%
	\end{center}
